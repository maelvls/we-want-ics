...
$PWD/celcat_to_ics.py g*.xml -r "M1 INF-IARF s1 TPA,M1 INF-IHM s1 TPA:compilation+M1 INF-SIAME s1 TPA,M1 INF-IHM s1 TPA:Algorithmique avancée+L1 PS s1 TPA2:EPMAS1D1 - Informatique" -o "$ICS"/mael.ics -v
